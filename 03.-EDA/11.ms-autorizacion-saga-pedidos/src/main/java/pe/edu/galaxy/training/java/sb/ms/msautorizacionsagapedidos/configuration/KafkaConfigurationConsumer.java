package pe.edu.galaxy.training.java.sb.ms.msautorizacionsagapedidos.configuration;
...
public class KafkaConfigurationConsumer {
	...
	@Value("${kafka.topic.topic-pedido-autorizacion-evaluado}")
	...
	public ConsumerFactory<String, PedidoAutorizacionMessage> pedidoConsumerFactory() {
		...
		config.put(JsonDeserializer.TRUSTED_PACKAGES, "pe.edu.galaxy.training.java.sb.ms.msautorizacionsagapedidos.message");
		config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "pe.edu.galaxy.training.java.sb.ms.msautorizacionsagapedidos.message.PedidoAutorizacionMessage");
	...
	@Bean
	ConcurrentKafkaListenerContainerFactory<String, PedidoAutorizacionMessage> pedidokafkaListenerContainerFactory() {
